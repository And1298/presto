        ...
        <section id="prodetails" class="section-p1">
            <div class="single">
                <div class="single-pro-image">
                    <div id="user-image-carousel" class="carousel slide bigimg active" data-bs-ride="carousel">
                        ...
                        @endif
                        <button class="carousel-control-prev" type="button" data-bs-target="#user-image-carousel"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#user-image-carousel"
                            data-bs-slide="next">
                ...
                {{-- Fine Dettagli immagine lato DX --}}
            </div>
        </section>
